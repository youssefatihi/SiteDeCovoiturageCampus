...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['num_trajet'])) {
    ...
    if ($confirm_delete === 'yes') {
        ...
        if ($stmt1->execute()) {
            ...
            echo "Route correctly deleted. Please note, all information relating to this journey has been deleted.";
        } else {
        ...
        echo "Deletion canceled. The route has not been deleted.";
    } else {
