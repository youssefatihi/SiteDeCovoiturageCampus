...
<body>
    ...
    <form action="insert_escale.php<?php
        ...
        <div class="form-group">
            ...
            <input type="text" name="num_passager" placeholder="Student number" required>
        </div>
        <button type="submit" class="submit-button">Add a stopover</button>
    </form>
</div>
